/**
 * Upload product imagery + video from public/assets into Supabase Storage, so the repo
 * carries no media. Idempotent (upserts), safe to re-run, and safe to point at a new
