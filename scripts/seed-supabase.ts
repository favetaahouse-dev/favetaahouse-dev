...
const adminEmail = (process.env.ADMIN_EMAIL || "admin@alessiaabaya.com").toLowerCase().trim();
const adminName = process.env.ADMIN_NAME || "Store Admin";
const demoEmail = (process.env.DEMO_EMAIL || "demo@alessiaabaya.com").toLowerCase().trim();
