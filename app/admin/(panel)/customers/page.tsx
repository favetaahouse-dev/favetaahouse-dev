  ...
  return (
    <div className="border border-white/10 bg-[#212121]">
      <div className="flex items-center justify-between border-b border-white/10 px-5 py-3">
        ...
        {/* A route handler streaming a CSV attachment, not a page. <Link> would try to
            client-navigate to it and never trigger the download, so the plain anchor is
            required; the rule cannot tell app/api routes from pages. */}
